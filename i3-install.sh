...
# Baixando pacotes
clear && sudo pacman -S git curl net-tools opensshd xorg-xrandr xclip libreoffice unzip usbutils wget pulseaudio-alsa pavucontrol qbittorrent youtube-dl fzf ueberzug noto-font brightnessctl dunst numlockx mpv libnotify viewnior python-pip pacman-contrib gvfs-mtp android-tools w3m neofetch nitrogen udev zsh zsh-syntax-highlighting qbittorent  redshift lib32-dbus-glib imagemagick jq lsd base-devel --noconfirm 
