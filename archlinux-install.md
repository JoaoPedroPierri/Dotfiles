...
```
sudo pacman -S i3 kitty git wget xorg-server xorg-xinit xdg-user-dirs ttf-jetbrains-mono ttf-nerd-fonts-symbols-mono ttf-font-awesome ttf-fantasque-sans-mono ttf-fira-code ttf-joypixels noto-fonts-emoji cmake python-sphinx --noconfirm && xdg-user-dirs-update
